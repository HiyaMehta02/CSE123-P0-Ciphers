...
public class Client {
    ...
    public static final Cipher CHOSEN_CIPHER = new MultiCipher(List.of(new CaesarKey("TIN"), new CaesarShift(6)));
    // CHOSEN_CIPHER.setEncoding("ABCDE");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        // ((CaesarShift) CHOSEN_CIPHER).setEncoding("ABCDE");
